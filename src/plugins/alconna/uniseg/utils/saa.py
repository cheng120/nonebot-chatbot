...
from src.plugins.alconna.uniseg.message import UniMessage
from src.plugins.alconna.uniseg.receipt import Receipt
from src.plugins.alconna.uniseg.segment import AtAll, Text

try:
    require("src.plugins.saa")
    from src.plugins.saa import MessageFactory, extract_target
    from src.plugins.saa.registries import MessageId
    from src.plugins.saa.registries import Receipt as SaaReceipt
    from src.plugins.saa.types.common_message_segment import Image, Mention, MentionAll, Reply, Text
    from src.plugins.saa.utils.exceptions import AdapterNotSupported
except ImportError:
