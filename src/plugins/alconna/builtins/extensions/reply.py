...
from src.plugins.alconna import Extension, Reply, UniMessage
from src.plugins.alconna.extension import cache_msg
from src.plugins.alconna.uniseg import get_message_id, reply_fetch
...
class ReplyRecordExtension(Extension):
    ...
    Example:
        >>> from src.plugins.alconna import MsgId, on_alconna
        >>> from src.plugins.alconna.builtins.extensions import ReplyRecordExtension
        >>>
...
class ReplyMergeExtension(Extension):
    ...
    Example:
        >>> from src.plugins.alconna import Match, on_alconna
        >>> from src.plugins.alconna.builtins.extensions.reply import ReplyMergeExtension
        >>>
