...
from src.plugins.alconna import Extension, Image, Text, UniMessage
from src.plugins.alconna.extension import TM, OutputType
...
class MarkdownOutputExtension(Extension):
    ...
    Example:
        ...
        >>> from src.plugins.alconna.builtins.extensions import MarkdownOutputExtension
        >>>
