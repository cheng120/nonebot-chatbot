...
from src.plugins.alconna import At, Extension, Image, UniMessage, log
from src.plugins.alconna.extension import cache_msg
from src.plugins.alconna.matcher import _M, AlconnaMatcher
...
class DiscordSlashExtension(Extension):
    ...
    Example:
        >>> from src.plugins.alconna import on_alconna
        >>> from src.plugins.alconna.builtins.extensions.discord import DiscordSlashExtension
        >>>
