...
from src.plugins.alconna import Extension, UniMessage, get_message_id
...
class MessageSentExtension(Extension):
    ...
    Example:
        >>> from src.plugins.alconna import add_global_extension
        >>> from src.plugins.alconna.builtins.extensions.onebot11 import MessageSentExtension
        >>>
