...
if TYPE_CHECKING:
    from src.plugins.alconna import Target
...
def to_target(
    ...
    try:
        from src.plugins.alconna import SupportAdapter as AlconnaSupportAdapter
        from src.plugins.alconna import SupportScope as AlconnaSupportScope
        from src.plugins.alconna import Target
    except ImportError:
